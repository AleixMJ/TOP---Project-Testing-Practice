...
Write tests for the following, and then make the tests pass! Remember that Jest does not have built-in stable support for ESM, so you will need to set up Babel for Jest ESM/CJS conversion.
